...
- [Free Support](https://app-generator.dev/ticket/create/?generated_repo=https://github.com/app-generator/django-tabler-1736184691) via `eMail` and `Discord`
...
```bash
$ git clone https://github.com/django-tabler-1736184691.git
$ cd django-tabler-1736184691
```
